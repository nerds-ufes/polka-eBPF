...
tc filter add dev h2-eth0 egress bpf obj encap_map_h21.o sec tc
tc qdisc add dev h2-eth1 clsact
tc filter add dev h2-eth1 egress bpf obj encap_map_h22.o sec tc

ip link set dev h2-eth0 xdp off
ip link set dev h2-eth0 xdp obj decap.o sec xdp
ip link set dev h2-eth1 xdp off
ip link set dev h2-eth1 xdp obj decap.o sec xdp
