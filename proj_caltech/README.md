# Polka-eBPF: CalTech Topology
![Topology - 01](figures/Topology-01.jpeg)

![Topology - 02](figures/Topology-02.jpeg)
## Building environment for eBPF:
### 1. To run, simply:
```
cd polka-eBPF/proj_caltech/
sudo python3 topo_caltech.py
```
```
mininet> h1 ping h2
mininet> h2 ping h1
